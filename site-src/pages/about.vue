<template>
        <div class="body">
                <article>
                        <h1>What the heck is this madness?</h1>
                        <p>
                ...
                <article>
                        <h2>More Info?</h2>
                        <p>
                                Before, I had a bunch of lorem ipsums here, but I don't think that makes sense. I'll relink that to the <NuxtLink to="/tests">tests page</NuxtLink>.
                        </p>
                </article>
        </div>
