...
.body
    .jumbo
        .grid_2x2.vh.mobile
            ...
            .top.right
                .flex.inline.columns.stretch.pad_2x.flex_end_justify.flex_gap_sm.flex_start_justify_mobileOnly
                    h3.text__align_center_mobileOnly Who am I?
                    p.text__align_justify_mobileOnly 
...
#personal-intro {
    ...
    color: @light-700;
    text-shadow: 4px 4px 6px @dark-700;
}
